...
def setup_product():
    ...
    import rendereasy.cnawhatsapp
    zcml.load_config('configure.zcml', rendereasy.cnawhatsapp)
    ...
    ztc.installPackage('rendereasy.cnawhatsapp')
...
setup_product()
ptc.setupPloneSite(products=['rendereasy.cnawhatsapp'])
